...
namespace Tests
{
    ...
    {
        [TestMethod]
        public void Race_GetTroopRedeploymentCount_ReturnsTotalRaceTokensMinusOwnedRegions()
        {
            var race = new Amazon();
            ...
            Assert.AreEqual(race.GetTroopRedeploymentCount([region1, region2]), 6);
        }
        ...
        [TestMethod]
        public void Skeleton_GetTroopRedeploymentCount_ReturnsExtraTroopsBasedOnNonEmptyRegionsConqueredThisTurn()
        {
            ...
            Assert.AreEqual(skeleton.GetTroopRedeploymentCount(regions), 7);

            skeleton.OnTurnStart();

            // No regions conquered this turn, will only get base redeployment
            Assert.AreEqual(skeleton.GetTroopRedeploymentCount(regions), 6);
        }
