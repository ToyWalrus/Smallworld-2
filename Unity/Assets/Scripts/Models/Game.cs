...
namespace Smallworld.Models
{
    ...
    public partial class Game : IGame
    {
        ...
        {
            // var powerFactory =  (Power)Activator.CreateInstance(type);
            //serviceProvider.GetRequiredService<IModelFactory<Power>>();
            ...
            return (Power)Activator.CreateInstance(randomPower);
        }
        ...
        private Race GetRandomRace(bool unused)
        {
            ...
            return (Race)Activator.CreateInstance(randomRace);
        }
